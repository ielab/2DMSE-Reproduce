...
from tevatron.retriever.modeling import EncoderOutput, DenseModel, DenseSeperatedModel, DenseSeperatedSharedModel, DenseRussianDollModel, Matryoshka2dDenseModel
...
def main():
    ...
    model = Matryoshka2dDenseModel.load(
