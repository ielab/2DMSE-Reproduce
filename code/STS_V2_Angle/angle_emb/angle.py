...
class AnglE(AngleBase):
    ...
    def fit(self,
        ...
        CustomTrainer = AngleESETrainer if (apply_ese or apply_mrl) else AngleTrainer
    ...
    def encode(self,
        ...
        """
        self.backbone.eval()
        print("embdding_size", embedding_size)
        if device is None:
            device = self.device
